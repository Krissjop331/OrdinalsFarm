...
export default function PlayPage() {
	...
	return (
		<div className='bg-blue-50 text-gray-800 min-h-screen flex flex-col items-center justify-center p-4'>
			{/* Фиксированная кнопка выхода */}
			<button
				onClick={handleExit}
				className='fixed top-4 left-4 px-4 py-2 bg-red-600 text-white rounded-lg shadow-lg hover:bg-red-700 transition z-50'
			...
			<div className='flex flex-col items-center text-center'>
				<h1
					className={`text-2xl sm:text-3xl md:text-4xl font-bold mb-4 ${ibmPlexMono.className}`}
					style={{
